...
function Settings() {
    ...
    return (
        <div className="size-full flex flex-col p-8 gap-4" style={{backgroundColor: theme.background}}>
            <Dropdown title="Theme" value={settings.theme} onChange={(newValue) => {
            ...
            <Dropdown title="Default selected language" value={settings.preferred_language} onChange={(newValue) => {
            ...
            <Checkbox title="Wrap lines" value={settings.wrap_lines} onChange={(newValue) => {
