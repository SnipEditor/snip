...
import {defaultSettingsTokyoNightStorm, tokyoNightStorm} from "@uiw/codemirror-theme-tokyo-night-storm";
import {defaultSettingsTokyoNightDay, tokyoNightDay} from "@uiw/codemirror-theme-tokyo-night-day";
...
export default function useTheme() {
    ...
    useEffect(() => {
        ...
        (async () => {
            ...
            unlisten = await window.onThemeChanged(({ payload: theme }: { payload: Theme }) => {
    ...
    const themePreference = settings.theme === 'System' ? normalizedSystemTheme : settings.theme
